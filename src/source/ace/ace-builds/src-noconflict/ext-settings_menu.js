ace.define(
  ...
  function(require, exports, module) {
    ...
    module.exports.createSelection = function createSelection(
      id,
      values,
      clss,
    ) {
...
ace.define('ace/ext/modelist', ['require', 'exports', 'module'], function(
  require,
  exports,
  module,
) {
...
ace.define(
  ...
  function(require, exports, module) {
    'use strict';
    module.exports.addEditorMenuOptions = function addEditorMenuOptions(
      editor,
    ) {
...
ace.define(
  ...
  function(require, exports, module) {
    ...
    var addEditorMenuOptions = require('./add_editor_menu_options')
      .addEditorMenuOptions;
    var getSetFunctions = require('./get_set_functions').getSetFunctions;
    module.exports.generateSettingsMenu = function generateSettingsMenu(
      editor,
    ) {
      var elements = [];
...
ace.define(
  ...
  function(require, exports, module) {
    'use strict';
    var generateSettingsMenu = require('./menu_tools/generate_settings_menu')
